...
<head>
    ...
    <link href="{{ asset('bookStore/lib/lightbox/css/lightbox.min.css') }}" rel="stylesheet">
    <link href="{{ asset('bookStore/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">


    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('bookStore/css/bootstrap.min.css') }}" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="{{ asset('bookStore/css/style.css') }}" rel="stylesheet">
</head>
...
<body>
    ...
    <script src="{{ asset('bookStore/lib/easing/easing.min.js') }}"></script>
    <script src="{{ asset('bookStore/lib/waypoints/waypoints.min.js') }}"></script>
    <script src="{{ asset('bookStore/lib/lightbox/js/lightbox.min.js') }}"></script>
    <script src="{{ asset('bookStore/lib/owlcarousel/owl.carousel.min.js') }}"></script>

    <!-- Template Javascript -->
    <script src="{{ asset('bookStore/js/main.js') }}"></script>
</body>
