        ...
        <div class="d-flex justify-content-between">
            <div class="top-info ps-2">
                <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#"
                        class="text-white">Jakarta, Indonesia</a></small>
                <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#"
                        class="text-white">Tobukel@gmail.com</a></small>
            </div>
                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0 bg-secondary rounded-0">
                            ...
                            <a href="{{ route('cart.index') }}" class="dropdown-item">Checkout</a> <a href="#"
                    ...
                    @auth
                        ...
                        <div class="nav-item dropdown my-auto">
                            ...
                            <div class="dropdown-menu dropdown-menu-end m-0 bg-secondary rounded-0">
                                ...
                                <a href="{{ route('orders.history') }}" class="dropdown-item">Riwayat Pesanan</a>
